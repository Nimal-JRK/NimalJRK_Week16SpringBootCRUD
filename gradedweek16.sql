...
--
-- Host: localhost    Database: springticket
-- ------------------------------------------------------
...
CREATE TABLE `ticket` (
  ...
  `ticket_booked_date` date DEFAULT NULL,
  `ticket_short_description` varchar(255) DEFAULT NULL,
...
INSERT INTO `ticket` VALUES (1,'<p>kjndkjnknDSJNDSKkmll</p>','2024-03-03','skjnjnskq','kdk'),(252,'<p>i am a good boy</p>','2024-03-03','singing','akash');
...
-- Dump completed on 2024-03-03 21:52:37
